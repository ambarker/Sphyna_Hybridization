...
with open('Library_data_files/SLH8/SLH8.Scall_Car_SPID.formatted.txt', 'rU') as f:
...
unknown = open('Results/SLH8/SLH8.unknown_scall_car_details.txt', 'w')
scalloped = open('Results/SLH8/SLH8.scalloped_details.txt', 'w')
carolina = open('Results/SLH8/SLH8.carolina_details.txt', 'w')
...
scalloped = open('Results/SLH8/SLH8.scalloped_ID.txt', 'w')
scall_write = open('Results/SLH8/SLH8_scall.bat', 'w')
for sp in scalloped_idv:
    scalloped.write(str(sp) + '\n')
    scall_write.write('ln -s ~/SLH8/' + str(sp) + '*.fq.gz .' + '\n')
scalloped.close()
scall_write.close()
carolina = open('Results/SLH8/SLH8.carolina_ID.txt', 'w')
carolina_write = open('Results/SLH8/SLH8_car.bat', 'w')
for sp in carolina_idv:
    carolina.write(str(sp) + '\n')
    carolina_write.write('ln -s ~/SLH8/' + str(sp) + '*.fq.gz .' + '\n')
carolina.close()
carolina.close()
unknown_namesonly = open('Results/SLH8/SLH8.unknown_scall_car_ID.txt', 'w')
unknown_write = open('Results/SLH8/SLH8_unknown.bat', 'w')
for sp in unknown_idv:
    unknown_namesonly.write(str(sp) + '\n')
    unknown_write.write('ln -s ~/SLH8/' + str(sp) + '*.fq.gz .' + '\n')
