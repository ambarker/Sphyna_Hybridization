...
with open('Library_data_files/SLH8/SLH8.ScallCar_Great_SPID.formatted.txt', 'rU') as f:
...
unknown = open('Results/SLH8/SLH8.unknown_scallcar_great_details.txt', 'w')
scallcar = open('Results/SLH8/SLH8.scallcar_details.txt', 'w')
great = open('Results/SLH8/SLH8.great_details.txt', 'w')
...
scalloped_carolina = open('Results/SLH8/SLH8.scallCar_ID.txt', 'w')
for sp in scallCar_idv:
    scalloped_carolina.write(str(sp) + '\n')
scalloped_carolina.close()
great = open('Results/SLH8/SLH8.great_ID.txt', 'w')
for sp in great_idv:
    great.write(str(sp) + '\n')
great.close()
unknown = open('Results/SLH8/SLH8.unknown_scalcar_gr_ID.txt', 'w')
